...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2023 at 11:11 PM
...
CREATE TABLE `orders` (
  ...
  `date_of_delivering` date DEFAULT NULL,
...
INSERT INTO `orders` (`command_id`, `product_id`, `user_id`, `adresse`, `code_postal`, `number_phone`, `quantity`, `total_amount`, `date_of_delivering`, `status`, `username`, `image_path`) VALUES
(0, 50, 1, '123 Main St', '12345', '555-1234', 2, 50.00, '2023-12-31', 'Pending', 'imane jarrari', 'pictures/p14.jpg'),
(1, 5, 3, '123 Main St', '12345', '555-123-4567', 2, 50.00, '2023-12-10', 'Pending', 'imane bll', 'pictures/s9.jpg'),
(3, 3, 1, '789 Pine St', '45678', '555-555-5555', 1, 30.25, '2023-12-15', 'Completed', 'imane jarrari', 'pictures/s7.jpg'),
(4, 4, 1, '987 Cedar St', '90123', '555-111-2222', 4, 120.75, '2023-12-18', 'cancelled', 'imane jarrari', 'pictures/s8.jpg');
...
(3, 'imane bll', 'jayjo@gmail.com', '$2y$10$asgCAEfLQcXF/N0e2/lomuzNQLJ2mrThpWZh0aDOvHbZpZn4sgTNq', '2023-12-02 19:17:34', 0);
